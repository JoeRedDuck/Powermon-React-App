...
export default function MetricCard ( {type="offline", value = 0, onPress} ) {
  const palette = {
  ...
  return (
    <TouchableOpacity style={cardStyles.metricCard} onPress={onPress || (() => router.push({ pathname: "/status", params: {status: type}}))}>
